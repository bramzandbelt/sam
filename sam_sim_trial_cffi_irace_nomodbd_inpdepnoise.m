function [rt,resp,z] = sam_sim_trial_cffi_irace_nomodbd_inpdepnoise(u,A,~,C,~,SI, ...
                                                         Z0,ZC,ZLB,dt, ...
                                                         tau,T, ...
                                                         terminate,~,~, ...
                                                         n,~,p,t, ...
                                                         rt,resp, ...
                                                         z)
% Simulate trials: C as feed-forward inhibition, I as a race, no extr. and intr. modulation
% 
% DESCRIPTION 
% SAM trial simulation function, modeling choice as a feed-forward 
% inhibition, inhibition as a race, and excluding extrinisic (B) or 
% intrinisic (D) modulation of connectivity.
%
% SYNTAX 
...
%
% [rt,resp,z] = SAM_SIM_TRIAL_CFFI_IRACE_NOMODBD(u,A,~,C,~,SI,Z0,ZC, ...
%                                                 ZLB,dt,tau,T, ...
%                                                 terminate,~,~,n,~,p, ...
%                                                 t,rt,resp,z);
%
...
% $Modified: Wed 25 Sep 2013 11:00:38 CDT by bram

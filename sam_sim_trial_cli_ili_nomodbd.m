function [rt,resp,z] = sam_sim_trial_cli_ili_nomodbd(u,A,~,C,~,SI, ...
                                                         Z0,ZC,ZLB,dt, ...
                                                         tau,T, ...
                                                         terminate,~,latInhib)
...
% inhibition as blocking the input, and excluding extrinisic (B) or 
...
% $Modified: Wed 18 Sep 2013 09:54:39 CDT by bram

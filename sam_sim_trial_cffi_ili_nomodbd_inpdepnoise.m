function [rt,resp,z] = sam_sim_trial_cffi_ili_nomodbd_inpdepnoise(u,A,~,C,~,SI, ...
                                                         Z0,ZC,ZLB,dt, ...
                                                         tau,T, ...
                                                         terminate,~,latInhib, ...
                                                         n,~,p,t, ...
                                                         rt,resp, ...
                                                         z)
% Simulate trials: C as feed-forward inhibition, I as lateral inhibition, no extr. and intr. modulation
% 
% DESCRIPTION 
...
%
% [rt,resp,z] = SAM_SIM_TRIAL_CFFI_ILI_NOMODBD(u,A,~,C,~,SI,Z0,ZC, ...
%                                                 ZLB,dt,tau,T, ...
%                                                 terminate,~,~, ...
%                                                 n,~,p,t,rt,resp,z);
%
...
% $Modified: Wed 25 Sep 2013 11:00:35 CDT by bram

function [rt,resp,z] = sam_sim_trial_crace_irace_nomodbd_inpdepnoise(u,A,~,C,~,SI, ...
                                                         Z0,ZC,ZLB,dt, ...
                                                         tau,T, ...
                                                         terminate,~,~, ...
                                                         n,~,p,t, ...
                                                         rt,resp, ...
                                                         z)
% Simulate trials: C as a race, I as a race, no extr. and intr. modulation
% 
% DESCRIPTION 
% SAM trial simulation function, modeling choice as a race, inhibition as a
% race, and excluding extrinisic (B) or intrinisic (D) modulation of
% connectivity.
%
% SYNTAX 

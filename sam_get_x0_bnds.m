function X = sam_get_x0_bnds(SAM,model)
% SAM_GET_X0_BNDS Get initial parameter values and bounds
%  
% DESCRIPTION 
...
% Bound distance from initial paremeter value; this can be multiplicative
% are additive
additive        = [0   0   0   0   0   0   0   0.5 1];
multiplicative  = [0.5 0.5 0.5 0.5 0.5 0.5 0.5 0   0];

% Hard limits on each parameter category
hardLB          = [zLB 0   0   0   0   0   0   -Inf     -Inf];
hardUB          = [Inf Inf Inf Inf Inf Inf Inf -realmin -realmin];

function [rt,resp,z] = sam_sim_trial_crace_ibi_nomodbd_inpdepnoise(u,A,~,C,~,SI, ...
                                                         Z0,ZC,ZLB,dt, ...
                                                         tau,T, ...
                                                         ...
                                                         rt,resp, ...
                                                         z)
% Simulate trials: C as a race, I as blocked input, no extr. and intr. modulation
% 
% DESCRIPTION 
...
%
% [rt,resp,z] = SAM_SIM_TRIAL_CRACE_IBI_NOMODBD(u,A,~,C,~,SI,Z0,ZC, ...
%                                                 ZLB,dt,tau,T, ...
%                                                 terminate,~,~, ...
%                                                 n,~,p,t,rt,resp,z);
%
...
% $Modified: Wed 25 Sep 2013 11:00:28 CDT by bram
